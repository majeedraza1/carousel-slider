    ...
    <div class="shapla-toggle-inner">
        <div class="shapla-toggle-content">
			...
			$this->form->number( array(
				'id'   => '_items',
				'type' => 'number',
				'name' => esc_html__( 'Colums', 'carousel-slider' ),
			...
			$this->form->number( array(
				'id'   => '_items_desktop',
				'type' => 'number',
				'name' => esc_html__( 'Colums : Desktop', 'carousel-slider' ),
			...
			$this->form->number( array(
				...
				'type' => 'number',
				'name' => esc_html__( 'Colums : Small Desktop', 'carousel-slider' ),
			...
			$this->form->number( array(
				...
				'name' => esc_html__( 'Colums : Tablet', 'carousel-slider' ),
			...
			$this->form->number( array(
				...
				'name' => esc_html__( 'Colums : Small Tablet', 'carousel-slider' ),
			...
			$this->form->number( array(
				...
				'name' => esc_html__( 'Colums : Mobile', 'carousel-slider' ),
