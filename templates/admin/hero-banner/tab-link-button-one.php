	...
	<div class="shapla-toggle-inner">
		<div class="shapla-toggle-content">
			...
			<div class="sp-input-group" id="field-button_one_target">
				<div class="sp-input-label">
					<label
						for="button_one_target"><?php esc_html_e( 'Open Button Link In', 'carousel-slider' ); ?></label>
				</div>
				<div class="sp-input-field">
					<select name="carousel_slider_content[<?php echo $slide_num; ?>][button_one_target]"
							id="button_one_target" class="sp-input-text">
						<option
							value="_blank" <?php selected( $_btn_1_target, '_blank' ); ?>><?php esc_html_e( 'New Window', 'carousel-slider' ); ?></option>
						<option
							value="_self" <?php selected( $_btn_1_target, '_self' ); ?>><?php esc_html_e( 'Same window', 'carousel-slider' ); ?></option>
					</select>
				</div>
			...
			<div class="sp-input-group" id="field-button_one_target">
				...
				<div class="sp-input-field">
					<select name="carousel_slider_content[<?php echo $slide_num; ?>][button_one_type]"
							id="button_one_target" class="sp-input-text">
						<option
							value="normal" <?php selected( $_btn_1_type, 'normal' ); ?>><?php esc_html_e( 'Normal', 'carousel-slider' ); ?></option>
						<option
							value="stroke" <?php selected( $_btn_1_type, 'stroke' ); ?>><?php esc_html_e( 'Stroke', 'carousel-slider' ); ?></option>
					</select>
				</div>
			</div><!-- Button Type -->
			...
			<div class="sp-input-group" id="field-button_one_size">
				...
				<div class="sp-input-field">
					<select name="carousel_slider_content[<?php echo $slide_num; ?>][button_one_size]"
						...
						<option
							value="large" <?php selected( $_btn_1_size, 'large' ); ?>><?php esc_html_e( 'Large', 'carousel-slider' ); ?></option>
						<option
							value="medium" <?php selected( $_btn_1_size, 'medium' ); ?>><?php esc_html_e( 'Medium', 'carousel-slider' ); ?></option>
						<option
							value="small" <?php selected( $_btn_1_size, 'small' ); ?>><?php esc_html_e( 'Small', 'carousel-slider' ); ?></option>
					</select>
				</div>
			</div><!-- Button Size -->
			...
			<div class="sp-input-group" id="field-button_one_border_width">
				<div class="sp-input-label">
					<label
						for="button_one_border_width"><?php esc_html_e( 'Border Width', 'carousel-slider' ); ?></label>
			...
			<div class="sp-input-group" id="field-button_one_border_radius">
				<div class="sp-input-label">
					<label
						for="button_one_border_radius"><?php esc_html_e( 'Border Radius', 'carousel-slider' ); ?></label>
