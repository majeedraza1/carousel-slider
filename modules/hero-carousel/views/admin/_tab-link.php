...
<div id="carousel-slider-tab-link" class="shapla-tab tab-content-link">
    ...
    <div class="ContentCarouselLinkButtons"
		...
		<?php include CAROUSEL_SLIDER_MODULES . '/hero-carousel/views/admin/_tab-link-button-one.php'; ?>
		<?php include CAROUSEL_SLIDER_MODULES . '/hero-carousel/views/admin/_tab-link-button-two.php'; ?>
    </div>
