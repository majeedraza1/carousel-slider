...
class AjaxAction {
	...
	/**
	 * Process hero carousel ajax action
	 */
	...
	private function content_slide_default() {
		$data = array(
			...
			'button_one_type'          => 'normal',
			'button_one_size'          => 'medium',
			'button_one_border_width'  => '0px',
			...
			'button_two_type'          => 'normal',
			'button_two_size'          => 'medium',
			'button_two_border_width'  => '0px',
