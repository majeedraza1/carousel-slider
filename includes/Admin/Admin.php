...
class Admin {
	...
	public static function init() {
		if ( is_null( self::$instance ) ) {
			...
			add_action( 'init', array( self::$instance, 'carousel_post_type' ) );
			add_filter( 'manage_edit-carousels_columns', array( self::$instance, 'columns_head' ) );
			add_filter( 'manage_carousels_posts_custom_column', array( self::$instance, 'columns_content' ), 10, 2 );
			...
			add_filter( "attachment_fields_to_edit", array( self::$instance, "attachment_fields_to_edit" ), null, 2 );
			add_filter( "attachment_fields_to_save", array( self::$instance, "attachment_fields_to_save" ), null, 2 );
		}
	...
	private function update_content_slider( $post_id ) {
		...
		$_slides         = array_map( function ( $slide ) {
			$_slide = array(
				...
				'video_overlay_color'      => Utils::sanitize_color( $slide['video_overlay_color'] ),
