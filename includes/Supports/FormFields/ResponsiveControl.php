...
class ResponsiveControl extends BaseField {
	...
	public function render(): string {
		...
		$breakpoints = $this->get_breakpoints_info();

		$html = '<div>';
		foreach ( $breakpoints as $key => $breakpoint ) {
			if ( ! in_array( $key, $devices, true ) ) {
				continue;
			}
			...
			$html .= '<span class="add-on cs-tooltip" title="' . $breakpoint['label'] . '">' . $breakpoint['icon'] . '</span>';
